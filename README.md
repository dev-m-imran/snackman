Developed an interactive Pac-Man–style browser game using HTML, CSS, and JavaScript, featuring grid-based movement, collision detection, and dynamic enemy AI.
